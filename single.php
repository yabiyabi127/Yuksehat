...
<html lang="en">
  ...
  <body>
    ...
    <?php include 'inc/nav.php'; ?>
      ...
      <!-- content -->
      <?php
        $query = mysqli_fetch_assoc(mysqli_query($koneksi, "select * from artikel where id='$_GET[id]'"));
      ?>
        <div class="container content">
            <div class="row">
                <h3 class="p-3 mt-2"><?=$query['judul'] ?></h3>
            </div>
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <figure class="figure">
                        <img src="img/<?=$query['gambar'] ?>" class="figure-img img-fluid rounded" width="500px">
