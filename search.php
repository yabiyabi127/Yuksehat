  ...
  <body>
    ...
    ?>
      ...
      <!-- content -->
        ...
        <div class="container">
            <div class="row">
                <h1 class="p-3 mt-2">Berdasarkan pencarian .....</h1>
            </div>
            <hr>
            <div class="row">
              <?php
                $value = $_GET['value'];
                $sql = mysqli_query($koneksi, "select * from penyakit where gejala LIKE '%$value%'");
                        ...
                        <div class="row no-gutters">
                          ...
                          <div class="col-md-8">
                            <div class="card-body">
                              ...
                              <p class="card-text"><?php echo substr($data['deskripsi'],0,200).' ..' ?></p>
